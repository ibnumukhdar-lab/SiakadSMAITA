...
<div class="space-y-0.5">
        ...
        <details class="nav-sec" {{ $srOn ? 'open' : '' }}>
            ...
            <div class="mt-0.5 space-y-0.5">
                ...
                <a href="{{ route('project-sr.index') }}" class="flex items-center gap-3 ps-10 pe-3 py-2 rounded-xl text-[13px] font-medium text-slate-600 hover:bg-slate-100 hover:text-slate-900 transition">
                    <span class="w-5 text-center text-[14px] shrink-0">📁</span> Project Student Root
                </a>
                ...
                <a href="{{ route('project-sr.master') }}" class="flex items-center gap-3 ps-10 pe-3 py-2 rounded-xl text-[13px] font-medium text-slate-600 hover:bg-slate-100 hover:text-slate-900 transition">
                    <span class="w-5 text-center text-[14px] shrink-0">⚙️</span> Tahap &amp; Bobot Project
                </a>
                @endcan
                @can('buka-menu-master-student-root')
    ...
    <div class="pt-3">
        ...
        <details class="nav-sec" {{ $nilaiOn ? 'open' : '' }}>
            ...
            <div class="mt-0.5 space-y-0.5">
                <a href="{{ route('penilaian.kelengkapan') }}" class="flex items-center gap-3 ps-10 pe-3 py-2 rounded-xl text-[13px] font-medium text-slate-600 hover:bg-slate-100 hover:text-slate-900 transition">
                    <span class="w-5 text-center text-[14px] shrink-0">✅</span> Kelengkapan Penilaian
                </a>
                <a href="{{ route('penilaian.rapot') }}" class="flex items-center gap-3 ps-10 pe-3 py-2 rounded-xl text-[13px] font-medium text-slate-600 hover:bg-slate-100 hover:text-slate-900 transition">
                    <span class="w-5 text-center text-[14px] shrink-0">🖨️</span> Rapot Adab &amp; Keasramaan
                </a>
        ...
        <details class="nav-sec" {{ $asOn ? 'open' : '' }}>
            ...
            <div class="mt-0.5 space-y-0.5">
                ...
                <a href="{{ route('asrama.absensi.index') }}" class="flex items-center gap-3 ps-10 pe-3 py-2 rounded-xl text-[13px] font-medium text-slate-600 hover:bg-slate-100 hover:text-slate-900 transition">
                    <span class="w-5 text-center text-[14px] shrink-0">🌙</span> Absensi Malam
                </a>
